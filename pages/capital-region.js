...
const schedule = [
  ...
  { time: '8:00 AM to 9:00 AM', event: 'Opening Ceremony & Team Formation' },
  { time: '9:00 AM', event: 'Start working on your project!' },
  { time: '12:00 PM', event: 'Lunch' },
  { time: '5:00 PM', event: 'Dinner' },
  { time: '6:00 PM', event: 'Demos!' },
  { time: '7:30 PM to 8:00 PM', event: 'Closing Ceremony' }
]
  ...
  return (
    ...
    >
      <Head>
        ...
        <title>Scrapyard Capital Region</title>
      </Head>
      <Flag />
      <Box
        sx={{
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {/* TODO: Change [EXAMPLECITY] to your event's city */}
              Capital Region NY | Tech Valley Center of Gravity | March&nbsp;16
            </Heading>
          </Box>
        </Box>
        <Box
        ...
        <Link
          ...
          href="https://forms.hackclub.com/scrapyard-signup?event=capital-region"
          target="_blank"
        >
          <Box
            sx={{
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {/* TODO: Change [EXAMPLECITY] to your event's city */}
              What's Scrapyard Capital Region?
            </Heading>
            <p
              style={{
                fontSize: '1.5em'
            ...
            >
              {/* TODO: Change [EXAMPLECITY] to your event's city */}
              Scrapyard Capital Region is a hackathon for high schoolers
              {/* TODO: Change [EXAMPLECITY] to your event's city */}
              happening in NY's Capital Region, where you can make the stupidest
      ...
      >
        ...
        >
          ...
          >
            {/* TODO: Change [EXAMPLECITY] to your event's city */}
            WHAT'S HAPPENING AT SCRAPYARD CAPITAL REGION?
          </Heading>
        </Box>
        <Heading
          as="h2"
        ...
        >
          ...
          Scrapyard Capital Region is a 12hour event - HERE'S THE ROUGH
          SCHEDULE!
        </Heading>
        <Box
          sx={{
      ...
      >
        ...
        >
          ...
          >
            {/* TODO: Change [EXAMPLECITY] to your event's city */}
            CAN'T MAKE IT TO THE CAPITAL REGION?
          </Heading>
        </Box>
        <Heading
          as="h2"
      ...
      >
          ...
          {Object.entries({
            ...
            'What if my parents are concerned?': (
              <>
                ...
                <Link href="mailto:nitya.clifton-park@scrapyard.hackclub.com">
                  {/* TODO: Change this email to your event's email */}
                  nitya.clifton-park@scrapyard.hackclub.com
                </Link>{' '}
                for questions.
              </>
            ),
            'What if I have more questions?': (
              <>
                ...
                Contact us! Feel free to reach out to us in the scrapyard-capital-region
        ...
        >
          ...
          >
            ...
            >
              {/* TODO: Change [EXAMPLECITY] to your event's city */}
              SIGN UP FOR SCRAPYARD CAPITAL REGION
            </Heading>
          </Box>
        </Link>
        <Heading
