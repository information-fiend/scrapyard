  ...
  return (
    ...
    >
      <Head>
        ...
        <title>Scrapyard Alexandria </title>
      </Head>
      <Flag />
      <Box
        sx={{
      ...
      >
        ...
        <Link
          ...
          href="https://forms.hackclub.com/scrapyard-signup?event=scrapyard-alexandria"
          target="_blank"
        >
          <Box
            sx={{
      ...
      >
        ...
        >
          ...
          >
            {/* TODO: Change [EXAMPLECITY] to your event's city */}
            WHAT'S HAPPENING AT SCRAPYARD Alexandria?
          </Heading>
        </Box>
        <Heading
          as="h2"
        ...
        >
          ...
          Scrapyard Alexandria is a 2-day event - HERE'S THE ROUGH
          SCHEDULE!
        </Heading>
        <Box
          sx={{
      ...
      >
          ...
          {Object.entries({
            ...
            'What if my parents are concerned?': (
              <>
                ...
                <Link href="alexandria@scrapyard.hackclub.com">
                  {/* TODO: Change this email to your event's email */}
                  alexandria@scrapyard.hackclub.com
                </Link>{' '}
                for questions.
              </>
            ),
        ...
        >
          ...
          >
            ...
            >
              {/* TODO: Change [EXAMPLECITY] to your event's city */}
              SIGN UP FOR SCRAPYARD ALEXANDRIA
            </Heading>
          </Box>
        </Link>
        <Heading
