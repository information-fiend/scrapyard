...
const schedule = [
    { time: '8:00 AM – 8:30 AM', event: 'Gates Open & Check-in at the Junkyard' },
    { time: '8:30 AM – 9:00 AM', event: 'Fuel Up: Breakfast & Networking' },
    { time: '9:00 AM – 9:30 AM', event: 'Squad Assembly & Battle Plans' },
    { time: '9:30 AM – 10:00 AM', event: 'Kickoff: Opening Ceremony & Theme Drop' },
    { time: '10:00 AM – 12:30 PM', event: 'Hack Session #1 + Skill Workshop' },
    { time: '12:30 PM – 1:15 PM', event: 'Pit Stop: Lunch Break' },
    { time: '1:15 PM – 4:00 PM', event: 'Hack Session #2: Building the Future' },
    { time: '4:00 PM – 4:20 PM', event: 'Brain Break: Fun & Chill Time' },
    { time: '4:20 PM – 5:00 PM', event: 'Final Sprint: Last Code & Submissions' },
    { time: '5:00 PM – 5:45 PM', event: 'Judging & Rapid-Fire Mentor Talks' },
    { time: '5:45 PM – 6:00 PM', event: 'Winners Announced & Closing Ceremony' }
  ];
...
export default function ExampleCity() {
  return (
    ...
    >
      <Head>
        {/* TODO: Change Rwamaganato your event's city */}
        <title>Scrapyard Rwamagana</title>
      </Head>
      <Flag />
      <Box
        sx={{
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {/* TODO: Change Rwamagana to your event's city */}
              Rwamagana - March&nbsp;15-16
            </Heading>
          </Box>
        </Box>
        <Box
        ...
        <Link
          // TODO: Change Rwamagana to your event's slug (lowercase, dashed version of your event name), such as san-francisco for Scrapyard San Francisco
          href="https://forms.hackclub.com/scrapyard-signup?event=Rwamagana"
          target="_blank"
        >
          <Box
            sx={{
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {/* TODO: Change Rwamagana to your event's city */}
              Scrapyard Rwamagana is a hackathon for high schoolers
              {/* TODO: Change Rwamagana to your event's city */}
              happening in Rwamagana, where you can make the stupidest
              ...
              {/* TODO: Change Rwamagana to your event's city */}
             Rwamagana needs you and your scrappy ideas!
            </p>
          </Box>
        </Box>
        <Box
      ...
      >
        ...
        >
          ...
          >
            {/* TODO: Change Rwamagana to your event's city */}
            WHAT'S HAPPENING AT Scrapyard Rwamagana?
          </Heading>
        </Box>
        <Heading
          as="h2"
        ...
        >
          ...
          Scrapyard Rwamagana is a 12-Hour event - HERE'S THE ROUGH
          SCHEDULE!
        </Heading>
        <Box
          sx={{
      ...
      >
          ...
          {Object.entries({
            ...
            'What if my parents are concerned?': (
              <>
                ...
                <Link href="mailto:alvintheprogrammer@gmail.com">
                  {/* TODO: Change this email to your event's email */}
                  alvintheprogrammer@gmail.com
                </Link>{' '}
                for questions.
              </>
            ),
            'What if I have more questions?': (
              <>
                ...
                Contact us! Feel free to reach out to us in the #Scrapyard-Rw
        ...
        >
          ...
          >
            ...
            >
              {/* TODO: Change Rwamagana to your event's city */}
              SIGN UP FOR Scrapyard Rwamagana
            </Heading>
          </Box>
        </Link>
        <Heading
